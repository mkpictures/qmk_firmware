 ...
 */
 ...
 [_QWERTY] = LAYOUT(
  ...
  KC_LSFT,  KC_Z,   KC_X,    KC_C,    KC_V,    KC_B, KC_RGUI,   KC_RBRC,  KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH,  KC_RSFT,
 ...
 */
[_LOWER] = LAYOUT(
        UG_TOGG, UG_NEXT, KC_HASH, _______, _______, _______,                   _______, _______, _______,_______, _______, _______,
